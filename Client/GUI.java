...
public class GUI {
	...
	private void initialize() {
		...
		kalender.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panelTermin.setBorder(new TitledBorder(null, "Termin", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		//if (rechte >= 1) {
			...
			tabbedPane.addTab("Terminverwaltung", null, panelTerminverwaltung, null);
			...
			spinDatumZeit.setModel(new SpinnerDateModel(new Date(-3600000L), null, null, Calendar.DAY_OF_YEAR));
			spinDatumZeit.setEditor(new JSpinner.DateEditor(spinDatumZeit, "dd.MM.yyyy HH:mm"));
			...
			//if (rechte >= 2) {
				...
				panelAusserzyklischenTerminErstellen.setBorder(new TitledBorder(new LineBorder(new Color(184, 207, 229)), "Au\u00DFerzyklischen Termin erstellen", TitledBorder.LEADING, TitledBorder.TOP, null, null));
				...
				spinDatumZeit2.setModel(new SpinnerDateModel(new Date(-3600000L), null, null, Calendar.DAY_OF_YEAR));
				spinDatumZeit2.setEditor(new JSpinner.DateEditor(spinDatumZeit2, "dd.MM.yyyy HH:mm"));
				...
				panelTauschanfrage.setBorder(new TitledBorder(new LineBorder(new Color(184, 207, 229)), "Tauschanfrage", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		//if (rechte >= 2) {
			...
			tabbedPane.addTab("Gruppenverwaltung", null, panelGruppenverwaltung, null);
			...
			panelMitgliedHinzufuegen.setBounds(424, 12, 453, 70);
			...
			panelRechteAendern.setBorder(new TitledBorder(null, "Rechte \u00E4ndern", TitledBorder.LEADING, TitledBorder.TOP, null, null));
			panelRechteAendern.setBounds(424, 96, 453, 70);
			...
			comboRechte.setModel(new DefaultComboBoxModel(new String[] {"Mitglied", "Ansprechpartner", "Gruppenleiter", "Administrator"}));
			...
			panelMitgliedLoeschen.setBorder(new TitledBorder(null, "Mitglied l\u00F6schen", TitledBorder.LEADING, TitledBorder.TOP, null, null));
			panelMitgliedLoeschen.setBounds(424, 178, 453, 70);
			...
			lblGruppe2.setBounds(12, 17, 45, 15);
		...
		panelAccountdatenAendern.setBorder(new TitledBorder(new LineBorder(new Color(184, 207, 229)), "Accountdaten \u00E4ndern", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		//if (rechte == 3) {
			...
			panelNutzer.setBorder(new TitledBorder(new LineBorder(new Color(184, 207, 229)), "Nutzer", TitledBorder.LEADING, TitledBorder.TOP, null, null));
			...
			JButton btnLoeschen3 = new JButton("Löschen");
			...
			scrollPane_3.setBounds(75, 102, 250, 88);
			...
			lblName3.setBounds(12, 30, 45, 15);
			...
			lblLeiter.setBounds(12, 67, 45, 15);
			...
			JButton btnAussetzen = new JButton("Aussetzen");
			btnAussetzen.setFont(new Font("Dialog", Font.PLAIN, 12));
			btnAussetzen.setBounds(337, 63, 120, 25);
			panelTermin2.add(btnAussetzen);
			
			scrollPane_4 = new JScrollPane();
			scrollPane_4.setBounds(75, 27, 250, 195);
	...
	private void eventHandler() {
		...
		btnAnmelden.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					int r = c.anmeldenClient(txtName.getText(), new String(pwdPasswort.getPassword()));
					switch (r) {
						case 0:
							panelMain.setVisible(true);
							String[] rechte = {"Mitglied", "Ansprechpartner", "Gruppenleiter", "Administrator"};
							lblWillkommen.setText("Angemeldet als " + txtName.getText() + " (" + rechte[c.rechte] + ")");
		...
		listTermine.addListSelectionListener(new ListSelectionListener() {
			public void valueChanged(ListSelectionEvent arg0) {
				...
				if (tmpTermin instanceof Termin) {
					...
					try {
						spinDatumZeit.setValue(format.parseObject(df.format(tmpTermin.datum) + " " + tf.format(tmpTermin.zeit)));
		...
		btnAendern3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//aendernTermin(tmpTermin.id, (Date) spinDatumZeit.getValue(), (Time) spinDatumZeit.getValue(), txtOrt.getText(), txtEssen2.getText());
			}
		});
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if(c.vergebenRechte(tmpPerson.id, r)==0)
						JOptionPane.showMessageDialog(frmMeetEat, "Rechtevergabe war erfolgreich!", "Rechtevergabe", JOptionPane.PLAIN_MESSAGE);
					else
						JOptionPane.showMessageDialog(frmMeetEat, "Fehler bei der Rechtevergabe", "Rechtevergabe", JOptionPane.PLAIN_MESSAGE);
				} catch (RemoteException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
		...
		btnErstellen.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (dateGeburtstag2.getSelectedDate() != null) {
					String datum = dateGeburtstag2.getSelectedDate().getYear() + "-" + dateGeburtstag2.getSelectedDate().getMonth() + "-" + dateGeburtstag2.getSelectedDate().getDay();
					...
					switch (r)
					{
						case 0:
							updateMitgliedList();
							JOptionPane.showMessageDialog(frmMeetEat, "Erfolgreich erstellt.", "Erstellen", JOptionPane.PLAIN_MESSAGE);
							break;
						case 1:
							JOptionPane.showMessageDialog(frmMeetEat, "Bitte Nutzername angeben.", "Erstellen", JOptionPane.PLAIN_MESSAGE);
							break;
						case 2:
							JOptionPane.showMessageDialog(frmMeetEat, "Bitte Passwort angeben.", "Erstellen", JOptionPane.PLAIN_MESSAGE);
							break;
						case 3:
							JOptionPane.showMessageDialog(frmMeetEat, "Bitte Passwort-Wiederholung angeben.", "Erstellen", JOptionPane.PLAIN_MESSAGE);
							break;
						case 4:
							JOptionPane.showMessageDialog(frmMeetEat, "Bitte Vorname angeben.", "Erstellen", JOptionPane.PLAIN_MESSAGE);
							break;
						case 5:
						...
						case 7:
							...
							break;
						case 8:
							JOptionPane.showMessageDialog(frmMeetEat, "Fehler beim Erstellen des Nutzers.", "Erstellen", JOptionPane.PLAIN_MESSAGE);
							break;
					}
				} else {
					JOptionPane.showMessageDialog(frmMeetEat, "Geburtstag angeben.", "Erstellen", JOptionPane.PLAIN_MESSAGE);
				}
	...
	private void ladeTermine() {
		try {
			...
			// TODO Auto-generated catch block
			e2.printStackTrace();
			JOptionPane.showMessageDialog(frmMeetEat, "Termine konnten nicht geladen werden.", "Anmelden", JOptionPane.PLAIN_MESSAGE);
		}
	}
	...
	private class PersonCellRenderer extends DefaultListCellRenderer {
	    public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
	        ...
	        if (value instanceof Person) {
	            setText(((Person)value).vorname + " " + ((Person)value).nachname + " (" + ((Person)value).nickname + ")");
	        }
	        return this;
	    }
	}
	...
	private class CustomCellRenderer extends JLabel implements CalendarCellRenderer { 
		...
		public JComponent getCellRendererComponent(CellRendererComponentParameter parameterObject) {
			...
			if (isSelected) {
				setBorder(BorderFactory.createCompoundBorder(new LineBorder(Color.BLACK), new EmptyBorder(3,4,0,0)));
			} else {
				if (isToday) {
					setBorder(BorderFactory.createCompoundBorder(new LineBorder(new Color(159, 216, 244)), new EmptyBorder(3,4,0,0)));
				} else {
	...
	private void addBusinessRules(JSCCalendar calendar) {
		...
		AbstractCalendarModel newRules = new AbstractCalendarModel() {
			...
			public boolean isDateSelectable(Date date) {
				...
				try {
					tmpTermin = c.anzeigenTermin(new java.sql.Date(date.getTime()));
				} catch (RemoteException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
			...
			public String getTextForHeading(DayOfWeek dayOfWeek) {
				...
				String firstLetter = dayOfWeek.getDisplayString(getCalendar().getLocale()).substring(0, 1).toUpperCase();
				String secondLetter = dayOfWeek.getDisplayString(getCalendar().getLocale()).substring(1, 2);
			...
			public void selectedDatesChanged(CalendarSelectionEvent calendarSelectionEvent) {
				...
				switch (selectionEventType) {
					case DATE_SELECTED: {
						Termin tmpTermin = null;
						try {
							tmpTermin = c.anzeigenTermin(new java.sql.Date(selectedDates.get(0).getTime()));
						} catch (RemoteException e) {
							// TODO Auto-generated catch block
							e.printStackTrace();
						}
